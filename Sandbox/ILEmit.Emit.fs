...
type ILTypeSkeleton() =
    ...
    override __.GetAttributeFlagsImpl() = notimpl
    override __.IsArrayImpl() = notimpl
    override __.IsByRefImpl() = notimpl
    override __.IsPointerImpl() = notimpl
    override __.IsPrimitiveImpl() = notimpl
...
let solveTypeVarMap vs v =
    let p = List.find (fun (p: ILTypeParameter) -> p.IL = v) vs
    p.Builder
